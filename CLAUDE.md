...
Also, use Opus-4.7 only if necessary while building, otherwise use Opus-4.6. It came out a few days ago and is an order of magnitude better than Sonnet and other models. If you can't find it, look it up first.
Gemini
Gemini response
